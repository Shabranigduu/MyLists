...
class MyLinkedListTest {
    ...
    MyList<Integer> emptyIntegerList = new MyLinkedList<>();
    int emptyIntegerListSize;
    MyList<Integer> integerList = new MyLinkedList<>();
    int integerListSize;
    MyList<Integer> integerListWithNullElements = new MyLinkedList<>();
    int integerListWithNullElementsSize;
    MyList<Example> exampleList = new MyLinkedList<>();
    int exampleListSize;
    MyList<ExampleWithComparable> exampleListWithComparable = new MyLinkedList<>();
